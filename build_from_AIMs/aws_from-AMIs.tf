...
resource "aws_security_group" "linuxtest" {
  name        = "Linuxtest Security Group"
  description = "SecurityGroup ports 22"
...
/*   ingress    {
  ...
  tags = {
    Name = "Security Group for Linuxtest"
  }
}